...
const ALL_CARDS = [
  ...
  { id:'thunder_clap',     name:'サンダークラップ',  icon:'🌩️', cost:1, desc:'敵全体に4ダメージ\n弱体1を与える',         type:'attack-all', value:4, allVulnerable:1,          rarity:'common' },
  { id:'heavy_blade',      name:'ヘヴィブレード',    icon:'🪓',  cost:2, desc:'14ダメージ\n筋力ボーナス3倍',             type:'attack',    value:14, strengthMultiplier:3,      rarity:'common' },
  { id:'body_slam',        name:'ボディスラム',      icon:'🏋️', cost:1, desc:'現在のブロック値の\nダメージを与える',      type:'attack',    value:0, damageEqualsBlock:true,   rarity:'common' },
  // ── コモン スキル ──────────────────────────────────────────────
  ...
  { id:'flex',             name:'フレックス',        icon:'💪',  cost:0, desc:'筋力2を得る\nターン終了時に筋力2を失う',   type:'skill',     gainStrength:2, loseStrengthEOT:2, rarity:'common' },
  // ── コモン パワー ──────────────────────────────────────────────
  ...
  { id:'rampage',          name:'ランページ',        icon:'😤',  cost:1, desc:'8ダメージ\n使用のたびダメージ+5',          type:'attack',    value:8, rampageDmgIncrease:5,      rarity:'uncommon' },
  { id:'reckless_charge',  name:'無謀なる突進',      icon:'💨',  cost:0, desc:'7ダメージ\nめまいを捨て札に追加',          type:'attack',    value:7, addDazeToDiscard:1,        rarity:'uncommon' },
  { id:'blood_for_blood',  name:'血には血を',        icon:'❤️',  cost:4, desc:'HPを失うたびコスト-1\n18ダメージ',         type:'attack',    value:18, hpLossCostReduction:true,  rarity:'uncommon' },
  { id:'cleave_soul',      name:'霊魂切断',          icon:'🌙',  cost:2, desc:'アタック以外の手札を廃棄\n16ダメージ',      type:'attack',    value:16, exhaustNonAttackHand:true, rarity:'uncommon' },
  // ── アンコモン スキル ──────────────────────────────────────────
  ...
  { id:'second_wind',      name:'セカンドウィンド',  icon:'🌬️', cost:1, desc:'アタック以外の手札を廃棄\n廃棄1枚につきブロック+5', type:'skill', secondWind:5,             rarity:'uncommon' },
  { id:'battle_trance',    name:'バトルトランス',    icon:'🧠',  cost:0, desc:'3枚ドロー\nこのターン追加ドロー不可',       type:'skill',     draw:3, noMoreDraw:true,           rarity:'uncommon' },
  { id:'intimidate',       name:'威嚇',              icon:'👹',  cost:0, desc:'敵全体に脱力1を与える\n廃棄',             type:'skill',     allWeak:1, exhaust:true,              rarity:'uncommon' },
  { id:'spot_weakness',    name:'弱点発見',          icon:'🔍',  cost:1, desc:'敵が攻撃予定なら\n筋力+3を得る',           type:'skill',     ifEnemyAttacking:true, gainStrength:3, rarity:'uncommon' },
  { id:'flame_barrier',    name:'炎の障壁',          icon:'🔥',  cost:2, desc:'12ブロック\n攻撃を受けるたび\n攻撃した敵に4ダメージ', type:'skill', value:12, flameBarrier:4,   rarity:'uncommon' },
  { id:'burning_pact',     name:'焦熱の契約',        icon:'📜',  cost:1, desc:'手札1枚を廃棄\n2枚ドロー',                 type:'skill',     exhaustChoose:true, draw:2,            rarity:'uncommon' },
  { id:'sentinel',         name:'見張り',            icon:'👁️', cost:1, desc:'5ブロック\n廃棄された時エネルギー+2',      type:'skill',     value:5, onExhaustGainEnergy:2,     rarity:'uncommon' },
  // ── アンコモン パワー ──────────────────────────────────────────
  ...
  { id:'evolve',           name:'進化',              icon:'🧬',  cost:1, desc:'状態以上カードの\nドロー時1枚追加ドロー', type:'power',     powerEffect:'evolve', powerStacks:1,     rarity:'uncommon' },
  { id:'dark_embrace',     name:'闇の抱擁',          icon:'🖤',  cost:2, desc:'カード破棄時\n1枚ドロー',                 type:'power',     powerEffect:'darkEmbrace', powerStacks:1, rarity:'uncommon' },
  { id:'flame_breath',     name:'炎の吐息',          icon:'🐉',  cost:1, desc:'状態異常か呪いを引くたび\n敵全体に6ダメージ', type:'power',  powerEffect:'flameBreath', powerStacks:6, rarity:'uncommon' },
  { id:'combust',          name:'燃焼',              icon:'💥',  cost:1, desc:'ターン終了時HP-1\n敵全体に5ダメージ',       type:'power',     powerEffect:'combust', powerStacks:5,     rarity:'uncommon' },
  // ── レア 攻撃 ─────────────────────────────────────────────────
  ...
  { id:'skull_bash',       name:'脳天割り',          icon:'💀',  cost:3, desc:'32ダメージ',                             type:'attack',    value:32,                          rarity:'rare' },
  // ── レア スキル ───────────────────────────────────────────────
  ...
  { id:'juggernaut',       name:'ジャガーノート',    icon:'⚙️',  cost:2, desc:'ブロック獲得時\nランダムな敵に5ダメージ', type:'power',     powerEffect:'juggernaut', powerStacks:5, rarity:'rare' },
  { id:'barricade',        name:'バリケード',        icon:'🏰',  cost:3, desc:'ターン開始時に\nブロックを失わない',       type:'power',     powerEffect:'barricade',           rarity:'rare' },
  { id:'berserk',          name:'狂戦士',            icon:'🪓',  cost:0, desc:'弱体2を得る\nターン開始時エネルギー+1',   type:'power',     gainJaku:2, powerEffect:'berserk',     rarity:'rare' },
  // ── ステータスカード ──────────────────────────────────────────
